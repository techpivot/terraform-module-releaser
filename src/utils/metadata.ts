...
export const ACTION_INPUTS: Record<string, ActionInputMetadata> = {
  ...
  'wiki-content-source': requiredString('wikiContentSource'),
  'wiki-include-changelog': requiredBoolean('wikiIncludeChangelog'),
  'wiki-readme-terraform-docs-marker': requiredString('wikiReadmeTerraformDocsMarker'),
