...
/**
 * Type for module reference mode values
 */
export type ModuleRefMode = (typeof ALLOWED_MODULE_REF_MODES)[number];

/**
 * Type guard to check if a value is a valid ModuleRefMode
 *
 * @param value - The value to check
 * @returns True if the value is a valid ModuleRefMode
 */
export function isModuleRefMode(value: unknown): value is ModuleRefMode {
  return typeof value === 'string' && ALLOWED_MODULE_REF_MODES.includes(value as ModuleRefMode);
}
