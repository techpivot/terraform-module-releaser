...
| `git-max-buffer`                 | Maximum buffer size in bytes for Git commands run while creating module tags and releases. Increase this when releases fail with `spawnSync /usr/bin/git ENOBUFS` in large monorepos.                                                                                                                                                                                                                                                                                                                                                                     | `1048576` (1 MiB)                                                                                      |
